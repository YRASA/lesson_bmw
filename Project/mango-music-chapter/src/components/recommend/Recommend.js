...
import * as AlbumModel from '@/model/album';  // 一次性把album.js所有模块都引入
import Lazyload, { forceCheck, lazyload } from 'react-lazyload';  // 图片延迟加载
// 1. 路由
// 2. redux
// 3. 切页面 + js
// 3. 生命周期 + api
...
class Recommend extends React.Component {
    constructor() {
        super()
        // 这个组件 this.state, 属于这个组件, 不属于其他组件
        // 1. 用假数据 把页面先做出来
        // 2. 未来再改成接口
        this.state = {
            refreshScroll: false,
